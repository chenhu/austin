...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "austin";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:austin";
    private final String revision = "2015-01-05";
    private final String resourcePath = "/META-INF/yang/austin.yang";
